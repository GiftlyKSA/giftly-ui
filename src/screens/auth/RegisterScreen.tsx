...
const createStyles = (C: ThemeColors, isRTL: boolean) => StyleSheet.create({
  ...
  registerBtn: { backgroundColor: C.primary, borderRadius: Radius.lg, paddingVertical: Spacing.base + 2, alignItems: 'center', marginTop: Spacing.sm, marginBottom: Spacing.base },
