...
const createStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  verifyBtn: { backgroundColor: C.primary, borderRadius: Radius.lg, paddingVertical: Spacing.base + 2, paddingHorizontal: Spacing.xxxl + Spacing.xl, marginBottom: Spacing.base },
