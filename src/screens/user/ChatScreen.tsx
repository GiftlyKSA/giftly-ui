...
const createStyles = (C: ThemeColors, isRTL: boolean) => StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.white, paddingHorizontal: Spacing.xl, paddingBottom: Spacing.base, gap: Spacing.sm },
