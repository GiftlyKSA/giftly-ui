...
const createStyles = (C: ThemeColors, isRTL: boolean) => StyleSheet.create({
  ...
  header: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: C.white, paddingHorizontal: Spacing.xl, paddingBottom: Spacing.base },
  ...
  hintCard: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'flex-start', backgroundColor: C.primaryLighter, borderRadius: Radius.lg, padding: Spacing.base, marginBottom: Spacing.xl, gap: Spacing.sm, borderWidth: 1, borderColor: C.primaryLight },
  ...
  labelRow: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', gap: Spacing.sm, marginBottom: Spacing.xs },
  ...
  selectBtn: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 2, borderColor: C.gray200, borderRadius: Radius.lg, paddingHorizontal: Spacing.base, paddingVertical: Spacing.md, backgroundColor: C.white },
  ...
  submitBtn: { backgroundColor: C.primary, borderRadius: Radius.lg, paddingVertical: Spacing.base + 2, alignItems: 'center', marginTop: Spacing.sm, ...Shadow.card },
