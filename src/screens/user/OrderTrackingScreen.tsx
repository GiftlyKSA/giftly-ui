...
const createStyles = (C: ThemeColors, isRTL: boolean) => StyleSheet.create({
  ...
  header: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: C.white, paddingHorizontal: Spacing.xl, paddingBottom: Spacing.base, borderBottomLeftRadius: Radius.lg, borderBottomRightRadius: Radius.lg },
  ...
  orderIdRow: { flexDirection: isRTL ? 'row-reverse' : 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: Spacing.base },
  ...
  orderMeta: { flexDirection: isRTL ? 'row-reverse' : 'row', justifyContent: 'space-between' }, metaDivider: { width: 1, backgroundColor: C.gray200 },
  ...
  stageRow: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'flex-start', position: 'relative', paddingBottom: Spacing.base },
  stageLine: { position: 'absolute', right: isRTL ? 19 : undefined, left: isRTL ? undefined : 19, top: 36, width: 2, height: '100%', backgroundColor: C.gray200 }, stageLineDone: { backgroundColor: C.primary },
  stageDot: { width: 40, height: 40, borderRadius: 20, backgroundColor: C.gray100, alignItems: 'center', justifyContent: 'center', marginLeft: isRTL ? Spacing.base : 0, marginRight: isRTL ? 0 : Spacing.base }, stageDotDone: { backgroundColor: C.primaryLighter }, stageDotActive: { backgroundColor: C.primary }, stageDotText: { fontFamily: Fonts.inter.bold, color: C.black },
