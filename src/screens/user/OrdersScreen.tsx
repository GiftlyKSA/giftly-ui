...
const createStyles = (C: ThemeColors, isRTL: boolean) => StyleSheet.create({
  ...
  header: { backgroundColor: C.white, paddingHorizontal: Spacing.xl, paddingBottom: Spacing.base, borderBottomLeftRadius: Radius.lg, borderBottomRightRadius: Radius.lg, alignItems: isRTL ? 'flex-end' : 'flex-start' },
  ...
  summary: { paddingHorizontal: Spacing.xl, marginBottom: Spacing.sm, alignItems: isRTL ? 'flex-end' : 'flex-start' },
